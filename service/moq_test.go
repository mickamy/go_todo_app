...
//			AddTaskFunc: func(ctx context.Context, db store.Executor, t *entity.Task) error {
...
func (mock *TaskAdderMock) AddTask(ctx context.Context, db store.Executor, t *entity.Task) error {
...
//			RegisterUserFunc: func(ctx context.Context, db store.Executor, u *entity.User) error {
...
func (mock *UserRegistererMock) RegisterUser(ctx context.Context, db store.Executor, u *entity.User) error {
...
//			GetUserFunc: func(ctx context.Context, db store.Queryer, id string) (*entity.User, error) {
...
func (mock *UserGetterMock) GetUser(ctx context.Context, db store.Queryer, id string) (*entity.User, error) {
	...
	return mock.GetUserFunc(ctx, db, id)
}
